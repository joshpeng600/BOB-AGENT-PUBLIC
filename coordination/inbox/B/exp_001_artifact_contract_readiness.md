...
ROLE=B
BRANCH=B-Part
ORIGIN_MAIN_SHA=05dff207484eda385c943dde57742eaf535a6906
IMPLEMENTATION_COMMIT_SHA=4fd009818a27afa198b49bf037aa24d48c2aa5b1
...
PYTEST=PASS_79_TESTS_26_SUBTESTS
UNIT_TESTS=PASS_79_OF_79
...
The correction provides all of the following:
...
- `validate_artifact_files()` resolves declared files below the run directory,
  requires each file to exist, recomputes SHA-256 from file bytes, and rejects
  any mismatch;
...
No C data implementation, D scientific logic, E evaluation algorithm,
...
```text
4fd009818a27afa198b49bf037aa24d48c2aa5b1
```
...
Synthetic regression coverage verifies the complete inventory, file-byte hash
matching, tamper rejection, missing/duplicate/unsafe-path rejection, and
fail-closed manifest status. Synthetic outputs are not formal evaluation input.
